...
class InvestigationCase(Base):
    ...
    alert_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("fraud_alerts.id"), nullable=True)
    ...
    outcome: Mapped[str | None] = mapped_column(String(30), nullable=True)  # confirmed_fraud|false_positive|inconclusive
