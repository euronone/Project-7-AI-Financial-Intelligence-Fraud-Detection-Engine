...
class FraudRule(Base):
    ...
    tenant_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("tenants.id"), nullable=True, index=True)  # None = global rule

    rule_name: Mapped[str] = mapped_column(String(255), nullable=False)
    rule_category: Mapped[str] = mapped_column(String(20), default="velocity")  # velocity|amount|geographic|device|pattern|behavioral
    ...
    notify_channels: Mapped[list | None] = mapped_column(JSON, default=list)  # ["email","sms","push"]
