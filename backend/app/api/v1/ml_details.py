...
_REGISTRY_PATH = Path(__file__).resolve().parents[3] / "app" / "ml" / "models" / "model_registry.json"
_FEATURE_NAMES_PATH = Path(__file__).resolve().parents[3] / "app" / "ml" / "models" / "feature_names_v1.json"
    ...
    catalogue = [
        {
            ...
            "key_features": ["amount", "velocity_1h", "hour_of_day", "country_risk", "amount_zscore"],
            "hyperparams": {"n_estimators": 150, "contamination": 0.03, "random_state": 42},
            "default_metrics": {"auc_roc": None, "precision": None, "recall": None, "accuracy": None, "f1_score": None},
        ...
        },
        {
            ...
            "key_features": ["amount", "location_lat", "location_lng", "txn_count_24h", "merchant_category_code"],
        ...
        },
        {
            ...
            "key_features": ["amount_zscore", "is_online", "is_new_device", "is_foreign", "customer_risk_score"],
            "hyperparams": {"C": 1.0, "class_weight": "balanced", "max_iter": 1000},
            "default_metrics": {"accuracy": 0.84, "precision": 0.78, "recall": 0.71, "f1_score": 0.745, "auc_roc": 0.89},
        ...
        },
        {
            ...
            "key_features": ["amount_zscore", "txn_count_1h", "is_new_device", "customer_risk_score", "is_foreign", "hour_of_day"],
            "hyperparams": {"n_estimators": 200, "max_depth": 12, "class_weight": "balanced", "random_state": 42},
            "default_metrics": {"accuracy": 0.91, "precision": 0.87, "recall": 0.84, "f1_score": 0.855, "auc_roc": 0.95},
        ...
        },
        {
            ...
            "key_features": ["amount_zscore", "velocity_ratio", "distance_from_last_txn", "is_new_device", "account_age_days", "customer_risk_score", "cross_border_high_amount"],
            "hyperparams": {"max_depth": 6, "learning_rate": 0.05, "n_estimators": 300, "scale_pos_weight": 32, "subsample": 0.8},
            "default_metrics": {"accuracy": 0.94, "precision": 0.91, "recall": 0.88, "f1_score": 0.895, "auc_roc": 0.967},
        ...
        },
        {
            ...
            "hyperparams": {"hidden_layer_sizes": [256, 128, 64], "dropout": 0.3, "activation": "relu", "max_iter": 200},
            "default_metrics": {"accuracy": 0.92, "precision": 0.89, "recall": 0.86, "f1_score": 0.875, "auc_roc": 0.955},
            "ensemble_weight": 0.10,
        },
        {
            "model_id":    "ensemble",
            ...
            "hyperparams": {
                "weights": {"rules": 0.25, "anomaly": 0.20, "xgboost": 0.30, "random_forest": 0.15, "neural_network": 0.10},
                "decision_thresholds": {"PASS": 0.30, "FLAG": 0.60, "ALERT": 0.80, "BLOCK": 1.0},
            },
            "default_metrics": {"accuracy": 0.96, "precision": 0.91, "recall": 0.88, "f1_score": 0.895, "auc_roc": 0.967},
    ...
    return [
        {
            ...
            "features": ["amount", "log_amount", "is_round_amount", "amount_zscore", "is_high_value", "amount_to_balance_ratio", "amount_vs_daily_avg", "pct_of_monthly_spend"],
        ...
        },
        {
            ...
            "features": ["txn_count_1h", "txn_count_6h", "txn_count_24h", "txn_count_7d", "txn_sum_1h", "txn_sum_24h", "unique_merchants_24h", "velocity_ratio", "velocity_z_score", "avg_inter_txn_minutes", "rapid_burst_flag", "acceleration"],
        ...
        },
        {
            ...
            "features": ["is_foreign", "high_risk_country", "distance_from_last_txn_km", "km_per_hour", "impossible_travel_flag", "is_cross_border", "country_risk_score", "city_change_flag"],
        ...
        },
        {
            ...
            "features": ["device_type", "is_mobile", "is_pos_terminal", "is_new_device", "device_age_days", "ip_risk_score", "is_vpn", "is_tor", "ip_country_mismatch", "shared_device_flag"],
        ...
        },
        {
            ...
            "features": ["hour_of_day", "day_of_week", "is_weekend", "is_night", "is_early_am", "is_holiday", "hour_sin", "hour_cos", "dow_sin", "dow_cos"],
        ...
        },
        {
            ...
            "features": ["customer_risk_score", "customer_tier", "balance_amount", "account_age_days", "kyc_level", "active_card_count", "historical_fraud_count", "days_since_last_fraud", "is_compromised_profile", "card_network", "card_compromised", "recent_password_reset"],
        ...
        },
        {
            ...
            "features": ["merchant_category_code", "high_risk_mcc", "is_online_merchant", "is_atm", "new_merchant_flag", "merchant_fraud_rate"],
...
def _static_samples() -> list[dict]:
    ...
    """
    return [
        {"transaction_id": "txn_001abcdef...", "amount": 45000.00, "channel": "online",       "merchant_name": "Amazon UK",       "city": "London",    "country_code": "GB", "device_type": "mobile",      "timestamp": "2025-06-15T22:30:00Z", "fraud_score": 0.94, "label": "fraud",      "fraud_category": "fraudulent", "risk_level": "critical", "triggered_rules": ["impossible_travel", "foreign_transaction", "large_amount"], "model_version": "ensemble_v1", "color": "#EF4444"},
        {"transaction_id": "txn_002abcdef...", "amount": 98000.00, "channel": "atm",           "merchant_name": "ATM Withdrawal",  "city": "Delhi",     "country_code": "IN", "device_type": "pos_terminal", "timestamp": "2025-06-16T03:15:00Z", "fraud_score": 0.88, "label": "fraud",      "fraud_category": "fraudulent", "risk_level": "critical", "triggered_rules": ["unusual_hour", "large_amount"], "model_version": "ensemble_v1", "color": "#EF4444"},
        {"transaction_id": "txn_003abcdef...", "amount": 12000.00, "channel": "online",        "merchant_name": "Flipkart",        "city": "Bangalore", "country_code": "IN", "device_type": "desktop",      "timestamp": "2025-06-17T14:00:00Z", "fraud_score": 0.82, "label": "fraud",      "fraud_category": "fraudulent", "risk_level": "critical", "triggered_rules": ["velocity_spike_1h"], "model_version": "ensemble_v1", "color": "#EF4444"},
        {"transaction_id": "txn_004abcdef...", "amount": 9500.00,  "channel": "online",        "merchant_name": "Unknown Merchant","city": "Mumbai",    "country_code": "IN", "device_type": "mobile",       "timestamp": "2025-06-18T02:45:00Z", "fraud_score": 0.79, "label": "fraud",      "fraud_category": "fraudulent", "risk_level": "high",     "triggered_rules": ["unusual_hour", "large_amount"], "model_version": "ensemble_v1", "color": "#EF4444"},
        {"transaction_id": "txn_005abcdef...", "amount": 55000.00, "channel": "online",        "merchant_name": "Travel Portal",   "city": "Dubai",     "country_code": "AE", "device_type": "desktop",      "timestamp": "2025-06-19T11:00:00Z", "fraud_score": 0.73, "label": "fraud",      "fraud_category": "fraudulent", "risk_level": "high",     "triggered_rules": ["foreign_transaction", "large_amount"], "model_version": "ensemble_v1", "color": "#EF4444"},
        {"transaction_id": "txn_006abcdef...", "amount": 15000.00, "channel": "mobile",        "merchant_name": "Croma",           "city": "Chennai",   "country_code": "IN", "device_type": "mobile",       "timestamp": "2025-06-20T19:30:00Z", "fraud_score": 0.65, "label": "fraud",      "fraud_category": "fraudulent", "risk_level": "high",     "triggered_rules": ["large_amount", "velocity_moderate"], "model_version": "ensemble_v1", "color": "#EF4444"},
        {"transaction_id": "txn_007abcdef...", "amount": 2500.00,  "channel": "pos_physical",  "merchant_name": "D-Mart",          "city": "Mumbai",    "country_code": "IN", "device_type": "pos_terminal", "timestamp": "2025-06-15T11:20:00Z", "fraud_score": 0.04, "label": "legitimate", "fraud_category": "legitimate", "risk_level": "low",      "triggered_rules": [], "model_version": "ensemble_v1", "color": "#22C55E"},
        {"transaction_id": "txn_008abcdef...", "amount": 800.00,   "channel": "pos_physical",  "merchant_name": "Cafe Coffee Day", "city": "Pune",      "country_code": "IN", "device_type": "pos_terminal", "timestamp": "2025-06-15T09:10:00Z", "fraud_score": 0.03, "label": "legitimate", "fraud_category": "legitimate", "risk_level": "low",      "triggered_rules": [], "model_version": "ensemble_v1", "color": "#22C55E"},
        {"transaction_id": "txn_009abcdef...", "amount": 3200.00,  "channel": "online",        "merchant_name": "Swiggy",          "city": "Bangalore", "country_code": "IN", "device_type": "mobile",       "timestamp": "2025-06-16T20:00:00Z", "fraud_score": 0.07, "label": "legitimate", "fraud_category": "legitimate", "risk_level": "low",      "triggered_rules": [], "model_version": "ensemble_v1", "color": "#22C55E"},
        {"transaction_id": "txn_010abcdef...", "amount": 1500.00,  "channel": "pos_physical",  "merchant_name": "BPCL Petrol",     "city": "Hyderabad", "country_code": "IN", "device_type": "pos_terminal", "timestamp": "2025-06-17T08:30:00Z", "fraud_score": 0.05, "label": "legitimate", "fraud_category": "legitimate", "risk_level": "low",      "triggered_rules": [], "model_version": "ensemble_v1", "color": "#22C55E"},
        {"transaction_id": "txn_011abcdef...", "amount": 18000.00, "channel": "online",        "merchant_name": "MakeMyTrip",      "city": "Mumbai",    "country_code": "IN", "device_type": "desktop",      "timestamp": "2025-06-18T15:00:00Z", "fraud_score": 0.11, "label": "legitimate", "fraud_category": "legitimate", "risk_level": "low",      "triggered_rules": [], "model_version": "ensemble_v1", "color": "#22C55E"},
        {"transaction_id": "txn_012abcdef...", "amount": 500.00,   "channel": "mobile",        "merchant_name": "BookMyShow",      "city": "Delhi",     "country_code": "IN", "device_type": "mobile",       "timestamp": "2025-06-19T16:45:00Z", "fraud_score": 0.02, "label": "legitimate", "fraud_category": "legitimate", "risk_level": "low",      "triggered_rules": [], "model_version": "ensemble_v1", "color": "#22C55E"},
    ]
