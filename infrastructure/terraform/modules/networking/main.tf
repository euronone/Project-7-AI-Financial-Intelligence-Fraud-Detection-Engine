...
resource "azurerm_subnet" "container_apps" {
  ...
  address_prefixes     = [var.subnet_cidrs["container_apps"]]
...
resource "azurerm_subnet" "cache" {
  ...
  resource_group_name  = var.resource_group_name
  virtual_network_name = azurerm_virtual_network.main.name
  address_prefixes     = [var.subnet_cidrs["cache"]]
}
...
resource "azurerm_network_security_group" "container_apps" {
  name                = "nsg-${var.project_name}-${var.environment}-container-apps"
  location            = var.location
  resource_group_name = var.resource_group_name
  tags                = var.tags
...
resource "azurerm_network_security_group" "database" {
  name                = "nsg-${var.project_name}-${var.environment}-database"
  location            = var.location
  resource_group_name = var.resource_group_name
  tags                = var.tags
...
resource "azurerm_network_security_group" "cache" {
  name                = "nsg-${var.project_name}-${var.environment}-cache"
  location            = var.location
  resource_group_name = var.resource_group_name
  tags                = var.tags
